...
def main(args):
	...
	while line:
		...
		if len(wordlist) and wordlist[0] == 'alpha[0]:':
			...
			gt = wordlist[14]
		line = fp.readline()
	print(other,threshold,time,log_like,ac,ag,at,cg,ct,gt)
if __name__ == "__main__":
	...
	parser.add_argument("-n","--num",type=float,required=True,help="collapse threshold")
	parser.add_argument("-a","--other_info",type=str,required=True,help="datasets/repo")
